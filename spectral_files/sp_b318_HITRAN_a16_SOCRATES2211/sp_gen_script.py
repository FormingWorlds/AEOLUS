...
# Write Rayleigh scattering (Block 3) in spectral file, 0: no, 1: yes
write_rayleigh  = 1
...
if write_spectrum == 1:
    ...
    f.write('/home/x_ryabo/soc-rad-conv/spectral_files/stellar_spectra/TRAPPIST-1_soc.txt'+ '\n')
...
if write_rayleigh == 1:
    ...
    #f.write(dir_socrates+'data/solar/kurucz_95'+ '\n')
    f.write('/home/x_ryabo/soc-rad-conv/spectral_files/stellar_spectra/TRAPPIST-1_soc.txt'+ '\n')
    # Atmosphere composition: air (A), H2-He gas (H) or custom composition (C) 
    f.write('C'+ '\n')
    # Number of gases to acount for or all gases listed in Block 0 (A)
    f.write('A'+ '\n')

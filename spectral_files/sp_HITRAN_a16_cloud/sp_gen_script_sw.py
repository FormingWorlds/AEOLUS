...
#dir_socrates    = "/home/lichtenberg/codes/socrates/socrates_2002/"
dir_socrates    = "/network/group/aopp/planetary/RTP028_BOUKROUCHE_RUNAWAY2/socrates/socrates_main/"
#dat_home        = "/network/group/aopp/planetary/RTP015_LICHTENBERG_20GEDGE/spectral_files/"
dat_home        = "/network/group/aopp/planetary/RTP028_BOUKROUCHE_RUNAWAY2/spectral_files/"
dir_continua    = dat_home+"dat_continua/"
dir_hitran      = dat_home+"dat_hitran/"
dir_hitemp      = dat_home+"dat_hitemp/"
dir_earthclouds = dat_home+"dat_earthclouds/"
...
# Write Earth-like water clouds in spectral file, 0: no, 1: yes
write_earthclouds = 1
Tclouds = 250.0       # assumed temperature of the clouds, Earth = 250 K. Adjust to the current study.
rho_cloud = 1.e3      # particle density of the cloud [kg/m^3].
...
if write_spectrum == 1:
    file_name = "sp_b"+band_no+"_"+database+"_a"+str(len(volatile_list))+"_sw"
else:
    file_name = "sp_b"+band_no+"_"+database+"_a"+str(len(volatile_list))+"_lw"
...
# -s Spectral file
# +p Planckian weighting replaced by +S Solar weighting
    ...
    if database == "HITEMP" and os.path.exists('temp/done_h2o_lbl') == False:
        ...
        for idx, band in enumerate(h2o_band_indices):
            ...
            if idx != 0:
                ...
                f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitemp+'01_'+hitemp_band_edge_left+'-'+hitemp_band_edge_right+'_HITEMP2010.par -R '+band_first+' '+band_last+' -c 3000.0 -i '+i_int+' -l 1 1.0e1 -b 1.5e-3 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -k -o h2o_l'+band_no+'_l -m h2o_l'+band_no+'_lm -L h2o_lbl_lwf_'+pt_lbl+'.nc -sm h2o_l'+band_no+'_'+band_first+'-'+band_last+'map.nc'+ '\n')
                f.write('prep_spec <<EOF'+ '\n')
                f.write(file_name+ '\n')
                f.write('a'+ '\n')
                f.write('5'+ '\n')
                ...
                f.write('Ccorr_k -F '+pt_cia+' -R '+band_first+' '+band_last+' -c 2500.0 -i '+i_int+' -ct 1 1 10.0 -t 1.0e-3 -e '+dir_continua+'mt_ckd_v3.0_s296 '+dir_continua+'mt_ckd_v3.0_s260 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o h2o-h2o_l'+band_no+'_'+band_first+'-'+band_last+'c -m h2o-h2o_l'+band_no+'_'+band_first+'-'+band_last+'cm -L h2o-h2o_lbl_lw.nc -lw h2o_l'+band_no+'_'+band_first+'-'+band_last+'map.nc'+ '\n')
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'h2o_data.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 1 1.0e1 -b 1.5e-3 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -k -o h2o_l'+band_no+'_l -m h2o_l'+band_no+'_lm -L h2o_lbl_lwf_pt48.nc -sm h2o_l'+band_no+'_1-'+band_no+'map.nc -np '+nprocs+'\n')
        # Add to spec file
        f.write('prep_spec <<EOF'+ '\n')
    ...
    if database == "HITEMP":
        ...
        for idx, band in enumerate(co2_band_indices):
            ...
            if idx != 0:
                ...
                f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitemp+'02_'+hitemp_band_edge_left+'-'+hitemp_band_edge_right+'_HITEMP2010.par -R '+band_first+' '+band_last+' -c 3000.0 -i '+i_int+' -l 2 1.0e1 -b 1.5e-3 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -k -o co2_l'+band_no+'_l -m co2_l'+band_no+'_lm -L co2_lbl_lwf_'+pt_lbl+'.nc -sm co2_l'+band_no+'_'+band_first+'-'+band_last+'map.nc'+ '\n')
                f.write('prep_spec <<EOF'+ '\n')
                f.write(file_name+ '\n')
                f.write('a'+ '\n')
                f.write('5'+ '\n')
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'co2_data.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 2 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o co2_o -m co2_m -L co2_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
...
if "O3" in volatile_list and os.path.exists('temp/done_o3_lbl') == False:
    ...
    f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'o3_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 3 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o o3_o -m o3_m -L o3_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('5'+ '\n')
...
if "N2O" in volatile_list and os.path.exists('temp/done_n2o_lbl') == False:
    ...
    if database == "HITEMP":
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitemp+'04_HITEMP2019.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 4 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o n2o_o -m n2o_m -L n2o_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'n2o_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 4 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o n2o_o -m n2o_m -L n2o_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
...
if "CO" in volatile_list and os.path.exists('temp/done_co_lbl') == False:
    ...
    if database == "HITEMP":
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitemp+'05_HITEMP2019.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 5 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o co_o -m co_m -L co_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'co_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 5 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o co_o -m co_m -L co_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
...
if "CH4" in volatile_list and os.path.exists('temp/done_ch4_lbl') == False:
    ...
    if database == "HITEMP":
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitemp+'06_HITEMP2020.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 6 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o ch4_o -m ch4_m -L ch4_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'ch4_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 6 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o ch4_o -m ch4_m -L ch4_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
...
if "O2" in volatile_list and os.path.exists('temp/done_o2_lbl') == False:
    ...
    f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'o2_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 7 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o o2_o -m o2_m -L o2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('5'+ '\n')
...
if "NO" in volatile_list and os.path.exists('temp/done_no_lbl') == False:
    ...
    if database == "HITEMP":
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitemp+'08_HITEMP2019.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 8 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o no_o -m no_m -L no_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'no_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 8 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o no_o -m no_m -L no_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
...
if "SO2" in volatile_list and os.path.exists('temp/done_so2_lbl') == False:
    ...
    f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'so2_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 9 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o so2_o -m so2_m -L so2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('5'+ '\n')
...
if "NO2" in volatile_list and os.path.exists('temp/done_no2_lbl') == False:
    ...
    if database == "HITEMP":
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitemp+'10_HITEMP2019.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 10 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o no2_o -m no2_m -L no2_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
        ...
        f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'no2_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 10 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o no2_o -m no2_m -L no2_lbl.nc -np '+nprocs+'\n')
        f.write('prep_spec <<EOF'+ '\n')
        f.write(file_name+ '\n')
        f.write('a'+ '\n')
        f.write('5'+ '\n')
...
if "NH3" in volatile_list and os.path.exists('temp/done_nh3_lbl') == False:
    ...
    f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'nh3_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 11 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o nh3_o -m nh3_m -L nh3_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('5'+ '\n')
...
if "HNO3" in volatile_list and os.path.exists('temp/done_hno3_lbl') == False:
    ...
    f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'hno3_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 12 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o hno3_o -m hno3_m -L hno3_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('5'+ '\n')
...
if "N2" in volatile_list and os.path.exists('temp/done_n2_lbl') == False:
    ...
    f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'n2_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 13 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o n2_o -m n2_m -L n2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('5'+ '\n')
...
# f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'h2_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 23 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o h2_o -m h2_m -L h2_lbl.nc -np '+nprocs+'\n')
# f.write('prep_spec <<EOF'+ '\n')
# f.write(file_name+ '\n')
# f.write('a'+ '\n')
# f.write('5'+ '\n')
...
if "OCS" in volatile_list and os.path.exists('temp/done_ocs_lbl') == False:
    ...
    f.write('Ccorr_k -F '+pt_lbl+' -D '+dir_hitran+'ocs_hitran.par -R 1 '+band_no+' -c 3000.0 -i '+i_int+' -l 25 1.0e1 -t 1.0e-2 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o ocs_o -m ocs_m -L ocs_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('5'+ '\n')
...
if "N2" in volatile_list and os.path.exists('temp/done_n2n2_cia') == False:
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'N2-N2_2018_fixed.cia -R 1 '+band_no+' -i '+i_int+' -ct 13 13 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o n2n2_o -m n2n2_m -L n2n2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if "O2" in volatile_list and os.path.exists('temp/done_o2o2_cia') == False:
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'O2-O2_2018b_fixed.cia -R 1 '+band_no+' -i '+i_int+' -ct 7 7 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o o2o2_o -m o2o2_m -L o2o2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if "H2" in volatile_list and os.path.exists('temp/done_h2h2_cia') == False:
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'H2-H2_CIA_Borysow_combined.cia -R 1 '+band_no+' -i '+i_int+' -ct 23 23 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o h2h2_o -m h2h2_m -L h2h2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    # Select block 19 (CIA data)
...
if "CO2" in volatile_list and os.path.exists('temp/done_co2co2_cia') == False:
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'CO2-CO2_2018_fixed.cia -R 1 '+band_no+' -i '+i_int+' -ct 2 2 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o co2co2_o -m co2co2_m -L co2co2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if "CH4" in volatile_list and os.path.exists('temp/done_ch4ch4_cia') == False:
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'CH4-CH4_2011.cia -R 1 '+band_no+' -i '+i_int+' -ct 6 6 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o ch4ch4_o -m ch4ch4_m -L ch4ch4_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if ("H2O" in volatile_list) and (database == "HITRAN") and (os.path.exists('temp/done_h2o_mtckd') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -R 1 '+band_no+' -c 2500.0 -i '+i_int+' -ct 1 1 10.0 -t 1.0e-3 -e '+dir_continua+'mt_ckd_v3.0_s296 '+dir_continua+'mt_ckd_v3.0_s260 -k -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o h2o-h2o_l'+band_no+'_1-'+band_no+'c -m h2o-h2o_l'+band_no+'_1-'+band_no+'cm -L h2o-h2o_lbl_lw.nc -lw h2o_l'+band_no+'_1-'+band_no+'map.nc -np '+nprocs+'\n')
    # Add to spec file with prep_spec
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name + '\n')
    f.write('a'+ '\n')
...
if ("CO2" in volatile_list) and ("CO2" in volatile_list) and (os.path.exists('temp/done_co2ch4_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'CO2-CH4_2018.cia -R 1 '+band_no+' -i '+i_int+' -ct 2 6 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o co2ch4_o -m co2ch4_m -L co2ch4_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if ("CO2" in volatile_list) and ("H2" in volatile_list) and (os.path.exists('temp/done_co2h2_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'CO2-H2_2018.cia -R 1 '+band_no+' -i '+i_int+' -ct 2 23 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o co2h2_o -m co2h2_m -L co2h2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if ("CO2" in volatile_list) and ("He" in volatile_list) and (os.path.exists('temp/done_co2he_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'CO2-He_2018.cia -R 1 '+band_no+' -i '+i_int+' -ct 2 24 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o co2he_o -m co2he_m -L co2he_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if ("CH4" in volatile_list) and ("He" in volatile_list) and (os.path.exists('temp/done_ch4he_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'CH4-He_2018.cia -R 1 '+band_no+' -i '+i_int+' -ct 6 24 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o ch4he_o -m ch4he_m -L ch4he_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if ("O2" in volatile_list) and ("CO2" in volatile_list) and (os.path.exists('temp/done_o2co2_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'O2-CO2_2011.cia -R 1 '+band_no+' -i '+i_int+' -ct 7 2 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o o2co2_o -m o2co2_m -L o2co2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if ("O2" in volatile_list) and ("N2" in volatile_list) and (os.path.exists('temp/done_o2n2_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'O2-N2_2018_fixed.cia -R 1 '+band_no+' -i '+i_int+' -ct 7 13 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o o2n2_o -m o2n2_m -L o2n2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if ("N2" in volatile_list) and ("H2O" in volatile_list) and (os.path.exists('temp/done_n2h2o_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'N2-H2O_2018.cia -R 1 '+band_no+' -i '+i_int+' -ct 13 1 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o n2h2o_o -m n2h2o_m -L n2h2o_lbl.nc -np '+nprocs+'\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
    f.write('y'+ '\n')
...
if ("N2" in volatile_list) and ("CH4" in volatile_list) and (os.path.exists('temp/done_n2ch4_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'N2-CH4_2011.cia -R 1 '+band_no+' -i '+i_int+' -ct 13 6 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o n2ch4_o -m n2ch4_m -L n2ch4_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if ("N2" in volatile_list) and ("H2" in volatile_list) and (os.path.exists('temp/done_n2h2_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'N2-H2_2011.cia -R 1 '+band_no+' -i '+i_int+' -ct 13 23 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o n2h2_o -m n2h2_m -L n2h2_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if ("N2" in volatile_list) and ("He" in volatile_list) and (os.path.exists('temp/done_n2he_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'N2-He_2018.cia -R 1 '+band_no+' -i '+i_int+' -ct 13 24 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o n2he_o -m n2he_m -L n2he_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if ("H2" in volatile_list) and ("CH4" in volatile_list) and (os.path.exists('temp/done_h2ch4_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'H2-CH4_eq_2011.cia -R 1 '+band_no+' -i '+i_int+' -ct 23 6 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o h2ch4_o -m h2ch4_m -L h2ch4_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    # Select block 19 (CIA data)
...
if ("H2" in volatile_list) and ("He" in volatile_list) and (os.path.exists('temp/done_h2he_cia') == False):
    ...
    f.write('Ccorr_k -F '+pt_cia+' -CIA '+dir_continua+'H2-He_2011.cia -R 1 '+band_no+' -i '+i_int+' -ct 23 24 1.0e2 -t 1.0e-2 -s '+file_name+' +S '+dir_socrates+'data/solar/lean_12 -lk -o h2he_o -m h2he_m -L h2he_lbl.nc -np '+nprocs+'\n')
    f.write('prep_spec <<EOF'+ '\n')
    f.write(file_name+ '\n')
    f.write('a'+ '\n')
    f.write('19'+ '\n')
...
if write_spectrum == 1:
    ...
    f.write(dir_socrates+'data/solar/lean_12'+ '\n')
...
if write_spectrum == 0:
    if write_earthclouds == 1:
        f.write("echo '###############   Earth clouds - LW   ###############'"+"\n")
        f.write('Cscatter_average -s ' +file_name+ ' -P  1 -t -p ' +str(Tclouds)+ ' -f 5 fit_lw_drop5 mon_lw_drop5 ' +str(rho_cloud)+' '+dir_earthclouds+'scatter_drop_type5')
    ...
    if write_earthclouds == 1:
        f.write("echo '###############   Earth clouds - SW   ###############'"+"\n")
        f.write('Cscatter_average -s ' +file_name+ ' -P  1 -t -S ' +dir_socrates+'data/solar/lean_12'+ ' -f 5 fit_sw_drop5 mon_sw_drop5 ' +str(rho_cloud)+' '+dir_earthclouds+'scatter_drop_type5')
        ...
        f.write('5'+ '\n')
        # Path to fit file
        f.write('fit_sw_drop5'+ '\n')
        # Radius range?
        f.write('2.00000E-06 5.00000E-05'+ '\n')
        # Exit
        f.write('-1'+ '\n')
        f.write('EOF'+ '\n')
